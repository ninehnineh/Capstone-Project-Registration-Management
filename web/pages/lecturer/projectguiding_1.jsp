                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="projectlist.jsp"><i class="fa fa-circle-o"></i> List of Projects</a></li>
                                <li class="active"><a href="projectguiding.jsp"><i class="fa fa-circle-o"></i> Project Guild</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
